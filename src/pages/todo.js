            ...
            <div className="grow shrink-0 w-[500px]">
                <div className="pt-5">
                    ...
                    {todo.isEditing ? (
                        ...
                        <button onClick={buttonClicked} className="mt-3 shadow bg-purple-500 hover:bg-purple-900 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
                            Add todo
                        </button>
                    )}
                </div>
